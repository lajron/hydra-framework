...
THRESHOLDS: tuple[Threshold, ...] = (
    ...
    Threshold("hydra_engine.knowledge.nodes", "DEFAULT_DEPTH", 3, ENGINE_INVARIANT, "default browseability depth"),
    Threshold("hydra_engine.knowledge.nodes", "MAX_DEPTH", 4, ENGINE_INVARIANT, "hard accountability-tree depth ceiling"),
